...
import { updateSession } from "@/app/utilities/actions";
...
export default function Home(){
    ...
    return(
        <main>
            ...
            <h2 className={components.Styles.heading}>Update Session</h2>
            <form id="session-form" action={updateSession}>
            ...
            <div className="flex justify-center">
                <input type="submit" className={components.Styles.button2} value="Update Session" />
