...
class _InvoiceReportScreenState extends ConsumerState<InvoiceReportScreen> {
  ...
  Future<void> intializeInovoices() async {
    filteredInvoices = await ref
        .read(invoiceNotifierProvider.notifier)
        .getInvoicesByDateAndStatus(fromDate, toDate, selectedStatus);
    init = true;
    setState(() {});
  }
  ...
  Widget build(BuildContext context) {
    ...
    List<Payment> payments = ref.read(paymentNotifierProvider).value!;
