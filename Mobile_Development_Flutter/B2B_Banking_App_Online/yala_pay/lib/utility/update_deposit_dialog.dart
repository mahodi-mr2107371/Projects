...
class _UpdateDepositDialogState extends ConsumerState<UpdateDepositDialog> {
  ...
  Map<String, DateTime?> returnDates = {}; // Store return dates for each cheque
  ...
  Future<void> _selectReturnDate(String chequeNumber) async {
  ...
  Widget build(BuildContext context) {
    ...
    List<ReturnReason> returnReasonsList =
        ref.watch(returnReasonProvider).value!;
