...
class ChequeStatusProvider extends Notifier<List<String>> {
  @override
  List<String> build() {
  ...
  Future<void> initializeState() async {
    List<String> temp = [];
    var data =
        await rootBundle.loadString('assets/YalaPay-data/cheque-status.json');
...
final chequeStatusProviderNotifier =
    NotifierProvider<ChequeStatusProvider, List<String>>(
