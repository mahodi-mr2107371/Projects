...
class _InvoiceScreenState extends ConsumerState<InvoiceScreen> {
        ...
        return AlertDialog(
          ...
          actions: [
            ...
            TextButton(
              onPressed: () {
                if (customers.any((e) =>
                    e.customerId == int.parse(customerIdController.text))) {
                  final newInvoice = Invoice(
                    invoiceNumber: isEditing ? id : ref.read(invoiceProvider.notifier).generateInvoiceNumber(),
  ...
  Widget build(BuildContext context) {
    ...
    invoices = ref.watch(invoiceProvider);
    _searchController.text = ref.read(invoiceProvider.notifier).query;
                    ...
                    IconButton(
                      onPressed: () {
                        setState(() {
                          ...
                          ref.read(invoiceProvider.notifier).invoiceSearch('');
                        });
                      },
